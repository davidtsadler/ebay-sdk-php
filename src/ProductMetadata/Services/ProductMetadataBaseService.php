...
class ProductMetadataBaseService extends \DTS\eBaySDK\Services\BaseService
{
    ...
    {
        parent::__construct('http://svcs.ebay.com/services/marketplacecatalog/ProductMetadataService/v1', 'http://svcs.sandbox.ebay.com/services/marketplacecatalog/ProductService/v1', $config);
    }
